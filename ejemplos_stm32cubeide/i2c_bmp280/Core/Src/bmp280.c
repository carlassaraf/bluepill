...
void bmp280_init(I2C_HandleTypeDef *hi2c) {
    ...
    HAL_I2C_Master_Transmit(i2c, ADDR, buf, 2, 100);
...
void bmp280_read_raw(int32_t* temp, int32_t* pressure) {
    ...
    HAL_I2C_Master_Transmit(i2c, ADDR, &reg, 1, 100);
    HAL_I2C_Master_Receive(i2c, ADDR, buf, 6, 100);
...
void bmp280_get_calib_params(struct bmp280_calib_param* params) {
    ...
    HAL_I2C_Master_Receive(i2c, ADDR, buf, NUM_CALIB_PARAMS, 100);
